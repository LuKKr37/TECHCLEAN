...
const WhatsAppButton = () => {
  return (
    ...
    >
      ...
      {/* Optimized Pulse Animation - using CSS animation with will-change */}
      <span className="absolute inset-0 rounded-full bg-[#25D366] animate-pulse opacity-40 will-change-opacity" />
    </a>
  );
};
